window.onload = function () {
    ...
    for (var i = 1; i <= M; i++) {
        ...
        oNewDiv.style.background = 'url(/resources/3D-ring/img/' + i + '.jpg)';

        oNewDiv.getElementsByClassName('shadow')[0].style.background = '-webkit-linear-gradient(rgba(0,0,0,1) 40%, rgba(255,255,255,0)), url(/resources/3D-ring/img/' + i + '.jpg)';
        oNewDiv.getElementsByClassName('shadow')[0].style.background = '-moz-linear-gradient(rgba(0,0,0,1) 40%, rgba(255,255,255,0)), url(/resources/3D-ring/img/' + i + '.jpg)';
        oNewDiv.getElementsByClassName('shadow')[0].style.background = '-ms-linear-gradient(rgba(0,0,0,1) 40%, rgba(255,255,255,0)), url(/resources/3D-ring/img/' + i + '.jpg)';
        oNewDiv.getElementsByClassName('shadow')[0].style.background = '-o-linear-gradient(rgba(0,0,0,1) 40%, rgba(255,255,255,0)), url(/resources/3D-ring/img/' + i + '.jpg)';
